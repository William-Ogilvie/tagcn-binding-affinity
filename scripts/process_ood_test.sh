...
#SBATCH --job-name=tagcn_process_OOD_Test_Graphs
...
# This script will generate the graphs for OOD Test
...
python generate_graphs.py --config_path config/graph_generation_OOD_Test.yml --device auto

# Generate scaling stats
python scaling_script.py --config_path config/scaling_generation_OOD_Test.yml